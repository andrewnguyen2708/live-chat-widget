 ...
 * 
 * Usage:
 * <script src="https://yourdomain.com/widget-loader.js?key=CLIENT_KEY" id="ze-snippet" async></script>
 */
(() => {
  // IMPORTANT: Update this URL to where you host the widget files
  const WIDGET_BASE_URL = "https://yourdomain.com"; // Change this to your actual domain
